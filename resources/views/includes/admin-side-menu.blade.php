      ...
      <ul class="navbar-nav flex-column">
        ...
        <li class="nav-item">
          ...
          <div id="submenu-3" class="collapse submenu" style="">
            <ul class="nav flex-column">
              <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3-1"
                  aria-controls="submenu-3-1">Offer Members</a>
                <div id="submenu-3-1" class="collapse submenu" style="">
                  <ul class="nav flex-column">
                    <li class="nav-item">
                <a class="nav-link" href="/admin/members">All Members<span
                    class="badge badge-secondary">New</span></a>
              </li>
                  </ul>
                </div>
              ...
              <li class="nav-item">
                <a class="nav-link" href="#" data-toggle="collapse" aria-expanded="false" data-target="#submenu-3-2"
                  aria-controls="submenu-3-2">Reservations</a>
                <div id="submenu-3-2" class="collapse submenu" style="">
                  <ul class="nav flex-column">
                    <li class="nav-item">
                <a class="nav-link" href="/admin/reservations">All Reservations<span
                    class="badge badge-secondary">New</span></a>
                    <a class="nav-link" href="/admin/reservations">New Reservation<span
                    class="badge badge-secondary">New</span></a>
              </li>
                  </ul>
                </div>
