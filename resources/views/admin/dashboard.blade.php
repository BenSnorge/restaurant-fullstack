                    ...
                    <div class="page-breadcrumb">
                        <nav aria-label="breadcrumb">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item active" aria-current="page">@if (Auth::user()->isAdmin())Last 30 Days Estimates
                        @else 
                        Latest Reservations
                        @endif
                                </li>
        ...
        <div class="ecommerce-widget">
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-6 col-md-6 col-sm-12 col-12">
                    <div class="card">
                        <div class="card-body">
                            <h5 class="text-muted">Estimadet Revenue</h5>
                    ...
                    <div class="card">
                        ...
                        <div class="card-footer">
                            <p class="display-7 font-weight-bold"><span class="text-primary d-inline-block">Estimated
                                    Revenue {{ $estimated_income_last_30 }}</span><span
